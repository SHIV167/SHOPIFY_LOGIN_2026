...
class ProductReviews {
  constructor(options = {}) {
    ...
    if (productElement) {
      ...
      this.productHandle = productElement.dataset.productHandle;
      this.productTitle = productElement.dataset.productTitle;
      ...
      if (window.Shopify && window.Shopify.product) {
        ...
        this.productHandle = window.Shopify.product.handle;
        this.productTitle = window.Shopify.product.title;
      }
